...
int16_t  si7021_humidity;    // latest humidity value read - Changed uint8_t to 16 (CoolWombat)
...
int8_t Plugin_014_si7021_startConv(uint8_t datatype, uint8_t resolution)
{
  ...
  */
  ...
  if (datatype == SI7021_MEASURE_HUM || datatype == SI7021_MEASURE_HUM_HM) {
    ...
    // save value
    si7021_humidity = (int16_t) data; //Changed unit8_t to init16_t (CoolWombat)
